...
func (x *BootstrapStreamRequest) GetResponse() *BootstrapStreamRequest_Response {
	if x, ok := x.GetType().(*BootstrapStreamRequest_Response_); ok {
		return x.Response
	}
	return nil
}
...
func (x *BootstrapStreamResponse) GetChallenge() *BootstrapStreamResponse_Challenge {
	if x, ok := x.GetType().(*BootstrapStreamResponse_Challenge_); ok {
		return x.Challenge
	}
	return nil
}
...
func (m *GetBootstrapDataRequest_Identity) GetType() isGetBootstrapDataRequest_Identity_Type {
	if m != nil {
		return m.Type
	}
	return nil
...
func (x *GetBootstrapDataRequest_Identity) GetIdevidCert() string {
	if x, ok := x.GetType().(*GetBootstrapDataRequest_Identity_IdevidCert); ok {
		return x.IdevidCert
	}
	return ""
}

func (x *GetBootstrapDataRequest_Identity) GetEkPub() string {
	if x, ok := x.GetType().(*GetBootstrapDataRequest_Identity_EkPub); ok {
		return x.EkPub
	}
	return ""
}

func (x *GetBootstrapDataRequest_Identity) GetPpkPub() string {
	if x, ok := x.GetType().(*GetBootstrapDataRequest_Identity_PpkPub); ok {
		return x.PpkPub
	}
	return ""
}
...
type GetBootstrapDataRequest_Identity_EkPub struct {
	EkPub string `protobuf:"bytes,2,opt,name=ek_pub,json=ekPub,proto3,oneof"`
}

type GetBootstrapDataRequest_Identity_PpkPub struct {
	PpkPub string `protobuf:"bytes,3,opt,name=ppk_pub,json=ppkPub,proto3,oneof"`
}
...
func (m *BootstrapStreamRequest_Response) GetType() isBootstrapStreamRequest_Response_Type {
	if m != nil {
		return m.Type
	}
	return nil
...
func (x *BootstrapStreamRequest_Response) GetNonceSigned() []byte {
	if x, ok := x.GetType().(*BootstrapStreamRequest_Response_NonceSigned); ok {
...
func (x *BootstrapStreamRequest_Response) GetNonce() string {
	if x, ok := x.GetType().(*BootstrapStreamRequest_Response_Nonce); ok {
		return x.Nonce
	}
	return ""
}
...
func (m *BootstrapStreamResponse_Challenge) GetType() isBootstrapStreamResponse_Challenge_Type {
	if m != nil {
		return m.Type
	}
	return nil
...
func (x *BootstrapStreamResponse_Challenge) GetNonce() string {
	if x, ok := x.GetType().(*BootstrapStreamResponse_Challenge_Nonce); ok {
		return x.Nonce
	}
	return ""
}
...
func (x *BootstrapStreamResponse_Challenge) GetNonceEncrypted() []byte {
	if x, ok := x.GetType().(*BootstrapStreamResponse_Challenge_NonceEncrypted); ok {
...
var file_github_com_openconfig_bootz_proto_bootz_proto_rawDesc = []byte{
	...
	0x12, 0x17, 0x0a, 0x06, 0x65, 0x6b, 0x5f, 0x70, 0x75, 0x62, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x48, 0x00, 0x52, 0x05, 0x65, 0x6b, 0x50, 0x75, 0x62, 0x12, 0x19, 0x0a, 0x07, 0x70, 0x70, 0x6b,
	0x5f, 0x70, 0x75, 0x62, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x06, 0x70, 0x70,
...
func file_github_com_openconfig_bootz_proto_bootz_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_openconfig_bootz_proto_bootz_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetBootstrapDataRequest_Identity); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_openconfig_bootz_proto_bootz_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BootstrapStreamRequest_Response); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_openconfig_bootz_proto_bootz_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BootstrapStreamResponse_Challenge); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_github_com_openconfig_bootz_proto_bootz_proto_msgTypes[16].OneofWrappers = []interface{}{
	...
	file_github_com_openconfig_bootz_proto_bootz_proto_msgTypes[17].OneofWrappers = []interface{}{
		(*BootstrapStreamRequest_Response_NonceSigned)(nil),
		(*BootstrapStreamRequest_Response_Nonce)(nil),
	}
	file_github_com_openconfig_bootz_proto_bootz_proto_msgTypes[18].OneofWrappers = []interface{}{
