...
type BootstrapStreamResponseV1_ChallengeRequest_ChallengeRequestTPM20HMAC struct {
	state         protoimpl.MessageState     `protogen:"open.v1"`
	KeyType       tpm_enrollz.Key            `protobuf:"varint,1,opt,name=key_type,json=keyType,proto3,enum=openconfig.attestz.Key" json:"key_type,omitempty"`
...
func (x *BootstrapStreamResponseV1_ChallengeRequest_ChallengeRequestTPM20HMAC) GetKeyType() tpm_enrollz.Key {
	if x != nil {
		return x.KeyType
	}
	return tpm_enrollz.Key(0)
...
const file_github_com_openconfig_bootz_proto_bootz_proto_rawDesc = "" +
	...
	"\x16report_status_response\x18\x03 \x01(\v2\x14.bootz.EmptyResponseH\x00R\x14reportStatusResponse\x1a\xf7\x04\n" +
	...
	"\x05nonce\x18\x01 \x01(\fR\x05nonce\x1a\x99\x01\n" +
	"\x19ChallengeRequestTPM20HMAC\x122\n" +
	"\bkey_type\x18\x01 \x01(\x0e2\x17.openconfig.attestz.KeyR\akeyType\x12H\n" +
...
var file_github_com_openconfig_bootz_proto_bootz_proto_depIdxs = []int32{
	...
	44, // 47: bootz.BootstrapStreamResponseV1.ChallengeRequest.ChallengeRequestTPM20HMAC.key_type:type_name -> openconfig.attestz.Key
	45, // 48: bootz.BootstrapStreamResponseV1.ChallengeRequest.ChallengeRequestTPM20HMAC.hmac_encrypted:type_name -> openconfig.attestz.HMACChallenge
	5,  // 49: bootz.Bootstrap.GetBootstrapData:input_type -> bootz.GetBootstrapDataRequest
	19, // 50: bootz.Bootstrap.ReportStatus:input_type -> bootz.ReportStatusRequest
	6,  // 51: bootz.Bootstrap.BootstrapStream:input_type -> bootz.BootstrapStreamRequest
	23, // 52: bootz.Bootstrap.BootstrapStreamV1:input_type -> bootz.BootstrapStreamRequestV1
	15, // 53: bootz.Bootstrap.GetBootstrapData:output_type -> bootz.GetBootstrapDataResponse
	20, // 54: bootz.Bootstrap.ReportStatus:output_type -> bootz.EmptyResponse
	7,  // 55: bootz.Bootstrap.BootstrapStream:output_type -> bootz.BootstrapStreamResponse
	24, // 56: bootz.Bootstrap.BootstrapStreamV1:output_type -> bootz.BootstrapStreamResponseV1
